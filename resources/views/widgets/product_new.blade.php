...
<div class="container container_cat pop_default cat_default mb__60">
    ...
    <div class="row al_center fl_center title_10 ">
        <div class="col-auto col-md"><h3 class="dib tc section-title fs__22 text-uppercase">Sản phẩm mới</h3></div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div id="shopify-section-collection_page" class="shopify-section tp_se_cdt">
                    ...
                    {{--                                       href="/collections/women?page=2&amp;sort_by=best-selling">2</a></li>--}}
                    {{--                                <li><a class="page-numbers"--}}
                    {{--                                       href="/collections/women?page=3&amp;sort_by=best-selling">3</a></li>--}}
                    {{--                                <li><a class="page-numbers"--}}
                    {{--                                       href="/collections/women?page=4&amp;sort_by=best-selling">4</a></li>--}}
                    {{--                                <li><a href="/collections/women?page=2&amp;sort_by=best-selling"--}}
                    {{--                                       class="next page-numbers">Next</a></li>--}}
                    {{--                            </ul>--}}
                    {{--                        </nav>--}}
                    {{--                    </div>--}}
