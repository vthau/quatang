...
<div class="post-related mt__50 mb__50">
    <h4 class="mg__0 mb__30 tu tc fwb">Bài Viết Liên Quan</h4>
                    ...
                    <div class="post-thumbnail pr oh">
                        <a class="db oh bgd" href="{{$other->getHref()}}">
                            <div class="nt_bg_lz pr_lazy_img lazyloaded"
                                 data-bgset="//cdn.shopify.com/s/files/1/0332/6420/5963/articles/1_1x1.jpg?v=1581524880"
                        ...
                        <div class="pa inside-thumb tc cg">
                            ...
                            <span class="post-time cg">
                                <time datetime="2020-04-06T02:22:00Z">{{date('M d, Y', strtotime($other->created_at))}}</time>
                            </span>
                        </div>
                    </div>
