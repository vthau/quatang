...
@section('content')
                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">thông tin chi tiết</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_ttct')}}" name="text_sp_ttct" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">thông tin khoa học</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_ttkh')}}" name="text_sp_ttkh" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">đánh giá từ chuyên gia</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_dgcg')}}" name="text_sp_dgcg" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">kích thước (vòng hông)</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_ktvh')}}" name="text_sp_ktvh" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">giới tính</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_gt')}}" name="text_sp_gt" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">dạng sản phẩm</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_dsp')}}" name="text_sp_dsp" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">điểm thấm hút</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_dth')}}" name="text_sp_dth" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">mức thấm hút</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_mth')}}" name="text_sp_mth" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">cân nặng (kg)</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_cn')}}" name="text_sp_cn" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">đơn vị</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_dv')}}" name="text_sp_dv" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">qui cách đóng gói</label>
                                                                <input value="{{$apiCore->getSetting('text_sp_qcdg')}}" name="text_sp_qcdg" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="tab-pane text_dk" role="tabpanel">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">chứng chỉ hành nghề</label>
                                                                <input value="{{$apiCore->getSetting('text_dk_chung_chi_hanh_nghe')}}" name="text_dk_chung_chi_hanh_nghe" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">đăng kí đối tác</label>
                                                                <input value="{{$apiCore->getSetting('text_dk_dang_ki_doi_tac')}}" name="text_dk_dang_ki_doi_tac" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">đăng kí chuyên gia</label>
                                                                <input value="{{$apiCore->getSetting('text_dk_dang_ki_chuyen_gia')}}" name="text_dk_dang_ki_chuyen_gia" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label style="text-transform: none !important;">Để đảm bảo rằng số điện thoại này là của bạn, chúng tôi sẽ gửi cho bạn một tin nhắn văn bản cùng mã xác minh gồm 6 chữ số.</label>
                                                                <input value="{{$apiCore->getSetting('text_dk_verify_title')}}" name="text_dk_verify_title" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label style="text-transform: none !important;">Nhập mã xác minh...</label>
                                                                <input value="{{$apiCore->getSetting('text_dk_verify_placeholder')}}" name="text_dk_verify_placeholder" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label style="text-transform: none !important;">Gửi lại mã xác minh</label>
                                                                <input value="{{$apiCore->getSetting('text_dk_verify_gui_lai')}}" name="text_dk_verify_gui_lai" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane text_tk" role="tabpanel">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Mã Đối Tác</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_mdt')}}" name="text_tk_mdt" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Thống Kê Hoa Hồng</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_tkhh')}}" name="text_tk_tkhh" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Trở Thành Đối Tác</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_ttdt')}}" name="text_tk_ttdt" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">QR code của đối tác</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_qrcode')}}" name="text_tk_qrcode" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Link giảm giá đến trang sản phẩm</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_link_sp')}}" name="text_tk_link_sp" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Link đăng kí thành viên</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_link_dk')}}" name="text_tk_link_dk" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Mã giới thiệu của đối tác</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_dtcode')}}" name="text_tk_dtcode" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Hoa hồng tháng tạm tính</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_thang_hoa_hong_1')}}" name="text_tk_thang_hoa_hong_1" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Hoa hồng tháng thực tế</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_thang_hoa_hong_2')}}" name="text_tk_thang_hoa_hong_2" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Doanh số NET tháng tạm tính</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_thang_doanh_so_net_1')}}" name="text_tk_thang_doanh_so_net_1" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Doanh số NET tháng thực tế</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_thang_doanh_so_net_2')}}" name="text_tk_thang_doanh_so_net_2" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Thưởng doanh số tháng tạm tính</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_thang_thuong_doanh_so_1')}}" name="text_tk_thang_thuong_doanh_so_1" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Thưởng doanh số tháng thực tế</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_thang_thuong_doanh_so_2')}}" name="text_tk_thang_thuong_doanh_so_2" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Danh sách khách hàng chăm sóc</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_ds_kh_care')}}" name="text_tk_ds_kh_care" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Danh sách đối tác</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_ds_dt_care')}}" name="text_tk_ds_dt_care" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Hoa hồng tháng</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_hoa_hong_thang_title')}}" name="text_tk_hoa_hong_thang_title" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Thống Kê Hoa Hồng Ghi Chú</label>
                                                                <textarea name="text_tk_tkhh_text" autocomplete="off" class="form-control" rows="5" cols="3">{{$apiCore->getSetting('text_tk_tkhh_text')}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Trở Thành Đối Tác Ghi Chú</label>
                                                                <textarea name="text_tk_ttdt_text" autocomplete="off" class="form-control" rows="5" cols="3">{{$apiCore->getSetting('text_tk_ttdt_text')}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">Cám ơn bạn đã đăng kí hợp tác với chúng tôi!</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_dk_hop_tac')}}" name="text_tk_dk_hop_tac" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">doanh số tháng NET tối thiểu đạt</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_tdst_dk_1')}}" name="text_tk_tdst_dk_1" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">tổng số đối tác đạt</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_tdst_dk_2')}}" name="text_tk_tdst_dk_2" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">có ít nhất 1 đơn hàng tại 1 nhánh đối tác</label>
                                                                <input value="{{$apiCore->getSetting('text_tk_tdst_dk_3')}}" name="text_tk_tdst_dk_3" type="text" autocomplete="off" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript" src="{{url('public/js/be/texts.js')}}"></script>
@stop
