...
$embeds = [
    'staff_level_delete', 'staff_user_delete', 'product_category_delete', 'product_brand_delete',
    'product_delete', 'order_config', 'order_ghn', 'order_manual',
    'order_confirm_paid', 'order_confirm_delete', 'order_delete', 'partner_update_refer',
    'partner_delete', 'partner_config', 'partner_report_view', 'client_delete',
...
@section('content')
    ...
    <script type="text/javascript">
        function changeLevel(ele) {
            ...
            parent.window.location.href = '{{url('admin/level/manage?level=')}}' + id;
        }
    </script>
@stop
