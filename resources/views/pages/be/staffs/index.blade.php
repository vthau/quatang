...
@section('content')
        ...
        <div class="fade-in">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="btn-menu">
                        <button class="btn btn-primary btn-sm mb-1" onclick="parent.window.location.href = '{{url('admin/staff/add')}}'" >
                                            ...
                                            <div class="align-right">
                                                ...
                                                @if ($viewer->isAllowed("staff_user_edit"))
                                                    <button class="btn btn-info btn-sm mb-1"
                                                            ...
                                                            onclick="gotoPage('{{url('admin/staff/add?id=' . $item->id)}}')"
                                                    >
    ...
    <script type="text/javascript" src="{{url('public/js/be/staffs.js')}}"></script>
@stop
