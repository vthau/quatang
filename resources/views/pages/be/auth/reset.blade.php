    ...
    <div class="login-wrap">
        <div class="login-content">
            ...
            <div class="login-form" id="frm-forgot">
                <form method="POST" action="" accept-charset="UTF-8" onsubmit="return doReset()" autocomplete="off" >
                    ...
                    <div class="form-group">
                        <input autocomplete="off" class="au-input au-input--full" type="password" name="password" id="frm-password" placeholder="********">
                    </div>
                    <div class="form-group" id="err-password">
                        <div class="alert alert-danger hidden">Hãy nhập mật khẩu.</div>
                    </div>

                    <button class="au-btn au-btn--block au-btn--green m-b-20" type="button" onclick="doReset()">thay đổi</button>
