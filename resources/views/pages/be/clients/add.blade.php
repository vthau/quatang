...
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="frm-label">chứng chỉ hành nghề</div>
                                            <input value="{{$user ? $user->chung_chi_hanh_nghe : ''}}" type="text" name="chung_chi_hanh_nghe" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="frm-label">thông tin chuyển khoản</div>
                                            <textarea name="thong_tin_chuyen_khoan" rows="5" cols="3" class="form-control">{{$user ? $user->thong_tin_chuyen_khoan : ''}}</textarea>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript" src="{{url('public/js/be/client_add.js')}}"></script>
