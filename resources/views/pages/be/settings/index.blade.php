...
@section('content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row hidden" id="req-bg_doctor">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="font-weight-bold">Background đăng kí cho chuyên gia</label>
                                            <div>
                                                <label>(Recommended: 1500 x 750)</label>
                                            </div>

                                            <div>
                                                <input name="site_bg_doctor" id="upload-bg_doctor" type="file" accept="image/*" />

                                                <div class="alert alert-danger hidden mt-3">Vui lòng không upload hình lớn hơn <b class="max-size-text"></b>.</div>
                                            </div>
                                        </div>

                                        <div class="form-group" id="bg_doctor-preview">
                                            @if ($logo3)
                                                <div class="bg_doctor_img">
                                                    <img src="{{$logo3->getPhoto()}}" />
                                                </div>
                                            @endif
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            $("#upload-bg_doctor").change(function () {
                jQuery('#req-bg_doctor .alert-danger').addClass('hidden');
                if(this.files[0].size > gks.maxSize) {
                    jQuery('#req-bg_doctor .alert-danger').removeClass('hidden');

                    jQuery(this).val("");
                    jQuery('#bg_doctor-preview').empty();
                    return false;
                }
                ...
                if (input.files && input.files[0] && (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                    ...
                    for (i = 0; i < filesAmount; i++) {
                        ...
                        reader.onload = function (e) {
                            $('#bg_doctor-preview').empty().append("<div class='bg_doctor_img'><img src='" + e.target.result + "' ></div>");
                        }
                        reader.readAsDataURL(input.files[i]);
                    }
                }
