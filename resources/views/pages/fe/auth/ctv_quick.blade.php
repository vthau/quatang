...
$bgDoctor = $apiCore->getSetting('site_bg_doctor');
?>
...
@section('content')
    ...
    <div class="container mt__30 mb__30">
        <div class="row">
            <div class="col-md-8">
                <div class="content bg_doctor" style="background-image:url('{{$bgDoctor}}')">

                </div>
            </div>
            <div class="col-md-4">
                <div class="frm_ctv">
                    <h3 class="text-uppercase">{{$apiCore->getSetting('text_dk_dang_ki_chuyen_gia')}}</h3>
                    <form method="post" action="{{url('auth/dk-dt-db')}}" accept-charset="UTF-8" id="frm-ctv"
                    ...
                    >
                        ...
                        <div class="form-row overflow-hidden clearfix mt__30">
                            ...
                            <button type="button" class="button fs-13 button_primary width_full text-uppercase mb__15" onclick="openPage('{{url('auth/redirect/facebook?f=ctvq')}}')">
                                <img width="20" class="mr__5" src="{{url('public/images/facebook.png')}}" style="margin-top: -5px;" /> {{$apiCore->getSetting('text_dk_facebook')}}
                            </button>
                            <button type="button" class="button fs-13 width_full text-uppercase mb__15" onclick="openPage('{{url('auth/redirect/google?f=ctvq')}}')">
