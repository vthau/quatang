...
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 @if ($item && $item->supplier_id) @else hidden @endif" id="req-supplier">
                                        <div class="form-group">
                                            <label class="frm-label required">nhà cung cấp</label>
    ...
    <script type="text/javascript" src="{{url('public/js/back_end/staff_add.js')}}"></script>
