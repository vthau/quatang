...
@section('content')
    ...
    <div>
        <div class="fade-in">
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-menu">
                        <button class="btn btn-primary  btn-sm mb-1" onclick="openPage('{{url('admin/event/add')}}')" >
                                        ...
                                        <td>
                                            <div class="align-right">
                                                <button class="btn btn-info btn-sm mb-1"
                                                        ...
                                                        onclick="openPage('{{url('admin/event/add?id=' . $item->id)}}')"
                                                >
    ...
    <script type="text/javascript" src="{{url('public/js/back_end/events.js')}}"></script>
