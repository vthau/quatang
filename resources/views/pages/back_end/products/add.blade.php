...
@section('content')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4" id="req-supplier">
                                        <div class="form-group">
                                            <label class="required">* Nhà Cung Cấp</label>
                                            <div class="select2-single-wrapper">
                                                <select required name="product_supplier_id" class="form-control select2-single select2-hidden-accessible">
                                                    @if (!$viewer->isSupplier())
                                                        <option value="">Hãy Chọn</option>
                                                    @endif
                                                    @foreach ($suppliers as $ite)
                                                        <option <?php if ($item && $item->product_supplier_id == $ite->id):?> selected="selected" <?php endif;?> value="{{$ite->id}}">{{$ite->getTitle()}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>

                                        <div class="form-group alert alert-danger hidden">Hãy chọn nhà cung cấp.</div>
                                    </div>
                                    ...
                                    <div class="col-md-4" id="req-brand">
                                        <div class="form-group">
                                            ...
                                            <div class="select2-single-wrapper">
                                                <select required name="product_brand_id" class="form-control select2-single select2-hidden-accessible">
                                                    ...
                                                    @foreach ($brands as $ite)
                                                        <option <?php if ($item && $item->product_brand_id == $ite->id):?> selected="selected" <?php endif;?> value="{{$ite->id}}">{{$ite->getTitle()}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4" id="req-price_main">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4" id="req-discount">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4" id="req-price_pay">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label class="c-switch c-switch-label c-switch-pill c-switch-danger float-left mr-2">
                                                    ...
                                                    <div class="text-uppercase">mở bán</div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="text-uppercase">sp mới</div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="text-uppercase">sp bán chạy</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3" id="req-quantity">
                                        <div class="form-group">
    ...
    <script type="text/javascript" src="{{url('public/js/back_end/product_add.js')}}"></script>
