        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="frm-search">
                    <form action="{{url('admin/orders')}}" method="get" id="frm-search">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-3 select2-single-wrapper">
                                        ...
                                        <select id="filter-product" name="product" class="form-control select2-single select2-hidden-accessible">
                                            ...
                                            <option <?php if (count($params) && isset($params['product']) && (int)$params['product'] == $ite->id) : ?>selected="selected" <?php endif; ?> value="{{$ite->id}}">{{$ite->getTitle()}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 hidden select2-single-wrapper">
                ...
                <div class="card-filter margin-bot-20">
                    <div class="float-left">
                        <div class="sum-stats">
                            ...
                            <div>
                                <span class="text-uppercase">TỔNG đã THANH TOÁN: </span>
                                <span class="money_format text-warning">{{$totalPriced}}</span>
                                <span class="currency_format text-warning">₫</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-responsive-sm table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="frm-label align-center hidden">Giảm Giá</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr id="order_{{$order->id}}">
                                        @include('modals.back_end.order_index_tr')
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
...
<script type="text/javascript" src="{{url('public/js/back_end/orders.js')}}"></script>
